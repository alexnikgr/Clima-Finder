<?php
/**
 * views/partials/legal_disclaimer.php (V27.0)
...
<div class="box" style="grid-column: span 12; background: rgba(255, 69, 58, 0.04); border-color: rgba(255, 69, 58, 0.15); margin-top: 15px; padding: 20px;">
    ...
    <p style="font-size: 0.72rem; color: #8e8e93; line-height: 1.6; margin: 0;">
        ...
        Οι υπολογισμοί βασίζονται σε παραδοχές των προτύπων ISO 13370 και Sol-Air και ενδέχεται να αποκλίνουν από την πραγματική κατανάλωση ανάλογα με τις τοπικές συνθήκες. 
        Η παρούσα αναφορά <u>δεν αποτελεί επίσημη ενεργειακή μελέτη</u> και δεν υποκαθιστά την υπογεγραμμένη μελέτη από διπλωματούχο Μηχανικό. 
        Ο πάροχος του λογισμικού δεν φέρει καμία ευθύνη για τυχόν αστοχίες στην επιλογή εξοπλισμού, οικονομικές απώλειες ή μηχανικές βλάβες.
    </p>
</div>
