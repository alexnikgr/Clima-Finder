...
/**
 * config/materials.php (V20.0)
 * Ρεαλιστικά U-Values για αμόνωτα κτίρια (Legacy) και προδιαγραφές υλικών.
 */
return [
    // Τύποι Τοιχοποιίας
    'U_WALL_TYPES' => [
    ...
    // ΕΝΗΜΕΡΩΜΕΝΑ U-VALUES (Legacy = Αμόνωτα)
    'U_ROOF_BASE' => [
        'terrace'      => ['legacy' => 3.10, 'medium' => 1.10, 'new' => 0.40], // Πλάκα χωρίς μόνωση
        'pitched'      => ['legacy' => 2.50, 'medium' => 0.90, 'new' => 0.35],
        'heated_above' => ['legacy' => 0.0, 'medium' => 0.0, 'new' => 0.0]
    ],

    'U_WALL' => ['legacy' => 2.80, 'medium' => 1.20, 'new' => 0.50], // Εξωτερικός αμόνωτος τοίχος

    'U_FLOOR_BASE' => [
        'ground'       => 0.80,
        'pilotis'      => 1.50, // Αμόνωτη pilotis (πολύ υψηλές απώλειες)
        'heated_below' => 0.0
    ],

    'LAMBDA' => [
        'none'     => ['label' => 'Χωρίς πρόσθετη μόνωση', 'lambda' => 0],
    ...
    'KOUFOMATA' => [
        'alum'        => ['label' => 'Αλουμίνιο (απλό)', 'u' => 5.8], // Παλιά αλουμίνια
